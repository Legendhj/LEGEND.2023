...
princp=[]
try:
	prox= requests.get('https://github.com/Legendhj/LEGEND.2023/blob/main/Legend.txt').text
	open('.Legend.txt','w').write(prox)
...
def uaku():
	try:
		ua=open('Legend.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/Legendhj/LEGEND.2023/blob/main/Legend.txt').text
		ua=open('.Legend.txt','w')
...
os.system('espeak -a 300 " Welcome,   to,  Legend,  Hi,  Tools"')
...
╠══[Facebook                 • Legends aryace ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mTutul-King ]   ║\33[1;34m   
╠══[Whatsapp                 •01837478901  ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
